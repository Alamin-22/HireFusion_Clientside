                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-md">
                        ...
                        <div className='md:flex space-y-3 md:space-y-0 md:space-x-10 lg:space-x-28 justify-center'>
                            <div>
                                <CountUp className='text-5xl text-[#8befe3cc]'start={0}  end={109234} duration={5} />
                                <p className='text-2xl'>Candidates</p>
                            </div>
                            <div>
                                <CountUp className='text-5xl text-[#8befe3cc]'start={0}  end={59234} duration={5} />
                                <p className='text-2xl'>Job Posted</p>
                            </div>
                            <div>
                                <CountUp className='text-5xl text-[#8befe3cc]'start={0}  end={40691} duration={5} />
                                <p className='text-2xl'>Job Success </p>
                            </div>
                            <div>
                                <CountUp className='text-5xl text-[#8befe3cc]'start={0}  end={600} duration={5} /><span className='text-5xl text-[#8befe3cc]'>+</span>
